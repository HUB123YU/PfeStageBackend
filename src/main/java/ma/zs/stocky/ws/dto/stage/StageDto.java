...
public class StageDto  extends AuditBaseDto {
    ...
    private List<StagePiecesAttachementDto> stagepiecesAttachement ;
    ...
    public List<StagePiecesAttachementDto> getStagepiecesAttachement(){
        return this.stagepiecesAttachement;
    }

    public void setStagepiecesAttachement(List<StagePiecesAttachementDto> stagepiecesAttachement){
