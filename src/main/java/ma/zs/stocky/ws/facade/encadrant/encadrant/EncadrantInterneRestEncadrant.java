package  ma.zs.stocky.ws.facade.encadrant.encadrant;
...
import ma.zs.stocky.service.facade.encadrant.encadrant.EncadrantInterneEncadrantService;
...
@RestController
@RequestMapping("/api/encadrant/encadrantInterne/")
public class EncadrantInterneRestEncadrant {
    ...
    public List<EncadrantInterneDto> findByGenreId(@PathVariable Long id){
    ...
    @Operation(summary = "find by nationalit id")
    @GetMapping("nationalit/id/{id}")
    public List<EncadrantInterneDto> findByNationalitId(@PathVariable Long id){
        return findDtos(service.findByNationalitId(id));
    }
    @Operation(summary = "delete by nationalit id")
    @DeleteMapping("nationalit/id/{id}")
    public int deleteByNationalitId(@PathVariable Long id){
        return service.deleteByNationalitId(id);
    }
    ...
    @Autowired private EncadrantInterneEncadrantService service;
