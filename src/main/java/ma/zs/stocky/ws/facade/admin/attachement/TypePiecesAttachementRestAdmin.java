package  ma.zs.stocky.ws.facade.admin.attachement;
...
@RestController
@RequestMapping("/api/admin/typePiecesAttachement/")
public class TypePiecesAttachementRestAdmin {
    ...
    @Autowired private TypePiecesAttachementAdminService service;
