package  ma.zs.stocky.ws.facade.encadrant.appartenance;
...
@RestController
@RequestMapping("/api/encadrant/nationalite/")
public class NationaliteRestEncadrant {
    ...
    @Autowired private NationaliteEncadrantService service;
