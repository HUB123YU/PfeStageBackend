package  ma.zs.stocky.ws.facade.encadrant.jury;
...
@RestController
@RequestMapping("/api/encadrant/jury/")
public class JuryRestEncadrant {
    ...
    @Autowired private JuryEncadrantService service;
