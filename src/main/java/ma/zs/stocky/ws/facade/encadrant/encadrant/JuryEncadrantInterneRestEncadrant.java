...
@RestController
@RequestMapping("/api/encadrant/juryEncadrantInterne/")
public class JuryEncadrantInterneRestEncadrant {
    ...
    @Autowired private JuryEncadrantInterneEncadrantService service;
