...
@RestController
@RequestMapping("/api/encadrant/stageEncadrantExterne/")
public class StageEncadrantExterneRestEncadrant {
    ...
    @Autowired private StageEncadrantExterneEncadrantService service;
