package  ma.zs.stocky.ws.facade.encadrant.etudiant;
...
@RestController
@RequestMapping("/api/encadrant/etudiant/")
public class EtudiantRestEncadrant {
    ...
    @Autowired private EtudiantEncadrantService service;
