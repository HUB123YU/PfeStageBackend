package  ma.zs.stocky.ws.facade.encadrant.departement;
...
@RestController
@RequestMapping("/api/encadrant/secteurActivite/")
public class SecteurActiviteRestEncadrant {
    ...
    @Autowired private SecteurActiviteEncadrantService service;
