package  ma.zs.stocky.ws.facade.etudiant.attachement;
...
@RestController
@RequestMapping("/api/etudiant/typePiecesAttachement/")
public class TypePiecesAttachementRestEtudiant {
    ...
    @Autowired private TypePiecesAttachementEtudiantService service;
