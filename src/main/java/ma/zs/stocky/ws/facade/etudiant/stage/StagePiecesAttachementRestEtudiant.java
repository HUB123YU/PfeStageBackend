...
@RestController
@RequestMapping("/api/etudiant/stagePiecesAttachement/")
public class StagePiecesAttachementRestEtudiant {
    ...
    @Autowired private StagePiecesAttachementEtudiantService service;
