...
@RestController
@RequestMapping("/api/encadrant/stageEncadrantInterne/")
public class StageEncadrantInterneRestEncadrant {
    ...
    @Autowired private StageEncadrantInterneEncadrantService service;
