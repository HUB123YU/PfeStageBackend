package  ma.zs.stocky.ws.facade.encadrant.stage;
...
@RestController
@RequestMapping("/api/encadrant/stagePiecesAttachement/")
public class StagePiecesAttachementRestEncadrant {
    ...
    @Autowired private StagePiecesAttachementEncadrantService service;
