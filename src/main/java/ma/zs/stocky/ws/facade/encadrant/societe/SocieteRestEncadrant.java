package  ma.zs.stocky.ws.facade.encadrant.societe;
...
@RestController
@RequestMapping("/api/encadrant/societe/")
public class SocieteRestEncadrant {
    ...
    @Autowired private SocieteEncadrantService service;
