...
public class StageConverter {
    ...
    @Autowired
    private StagePiecesAttachementConverter stagePiecesAttachementConverter ;
    @Autowired
    ...
    private boolean stagepiecesAttachement;
    ...
    public Stage toItem(StageDto dto) {
        ...
        Stage item = new Stage();
            ...
            if(this.stagepiecesAttachement && ListUtil.isNotEmpty(dto.getStagepiecesAttachement()))
                item.setStagepiecesAttachement(stagePiecesAttachementConverter.toItem(dto.getStagepiecesAttachement()));
    ...
    public StageDto toDto(Stage item) {
        ...
        if(this.stagepiecesAttachement && ListUtil.isNotEmpty(item.getStagepiecesAttachement())){
            stagePiecesAttachementConverter.init(true);
            stagePiecesAttachementConverter.setStage(false);
            dto.setStagepiecesAttachement(stagePiecesAttachementConverter.toDto(item.getStagepiecesAttachement()));
            stagePiecesAttachementConverter.setStage(true);
    ...
    public void initList(boolean value) {
        ...
        this.stagepiecesAttachement = value;
    }
    ...
    public void copy(StageDto dto, Stage t) {
        ...
        if (dto.getStagepiecesAttachement() != null)
            t.setStagepiecesAttachement(stagePiecesAttachementConverter.copy(dto.getStagepiecesAttachement()));
    }
    ...
    public StagePiecesAttachementConverter getStagePiecesAttachementConverter(){
        return this.stagePiecesAttachementConverter;
    }
    public void setStagePiecesAttachementConverter(StagePiecesAttachementConverter stagePiecesAttachementConverter ){
        this.stagePiecesAttachementConverter = stagePiecesAttachementConverter;
    }
    ...
    public boolean  isStagepiecesAttachement(){
        return this.stagepiecesAttachement ;
    }
    public void  setStagepiecesAttachement(boolean stagepiecesAttachement ){
        this.stagepiecesAttachement  = stagepiecesAttachement ;
    }
}
