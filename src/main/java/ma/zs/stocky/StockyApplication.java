...
public class StockyApplication {
    ...
    @Bean
    public CommandLineRunner demo(UserService userService, RoleService roleService, ModelPermissionService modelPermissionService, ActionPermissionService actionPermissionService, ModelPermissionUserService modelPermissionUserService , EtudiantAdminService etudiantService) {
    return (args) -> {
        if(true){
		...
		// User Encadrant
        User userForEncadrant = new User("encadrant");
		userForEncadrant.setPassword("123");
		// Role Encadrant
    ...
    private static void addPermission(List<ModelPermission> modelPermissions) {
        ...
        modelPermissions.add(new ModelPermission("PiecesAttachement"));
        modelPermissions.add(new ModelPermission("Departement"));
        modelPermissions.add(new ModelPermission("TypePiecesAttachement"));
        ...
        modelPermissions.add(new ModelPermission("StagePiecesAttachement"));
