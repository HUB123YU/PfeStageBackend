...
public class Stage  extends BaseEntity     {
    ...
    private List<StagePiecesAttachement> stagepiecesAttachement ;
    ...
    @OneToMany(mappedBy = "stage")
    public List<StagePiecesAttachement> getStagepiecesAttachement(){
        return this.stagepiecesAttachement;
    }

    public void setStagepiecesAttachement(List<StagePiecesAttachement> stagepiecesAttachement){
