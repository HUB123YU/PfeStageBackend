package ma.zs.stocky.service.impl.encadrant.attachement;
...
import java.util.List;
@Service
public class PiecesAttachementEncadrantServiceImpl implements PiecesAttachementEncadrantService {
    ...
    @Autowired
    private TypePiecesAttachementEncadrantService typePiecesAttachementService ;
    @Autowired
