...
import ma.zs.stocky.service.facade.encadrant.departement.SecteurActiviteEncadrantService ;
import ma.zs.stocky.bean.core.departement.SecteurActivite ;
import ma.zs.stocky.service.facade.encadrant.appartenance.VilleEncadrantService ;
import ma.zs.stocky.bean.core.appartenance.Ville ;
import ma.zs.stocky.service.facade.encadrant.appartenance.PaysEncadrantService ;
import ma.zs.stocky.bean.core.appartenance.Pays ;

import java.util.List;
@Service
public class SocieteEncadrantServiceImpl implements SocieteEncadrantService {
    ...
    @Autowired
    private SecteurActiviteEncadrantService secteurActiviteService ;
    @Autowired
