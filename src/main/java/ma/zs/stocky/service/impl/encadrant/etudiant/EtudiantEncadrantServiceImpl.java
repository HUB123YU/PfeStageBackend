package ma.zs.stocky.service.impl.encadrant.etudiant;
...
import ma.zs.stocky.service.facade.encadrant.etudiant.EtudiantEncadrantService;
...
import ma.zs.stocky.service.facade.encadrant.appartenance.NationaliteEncadrantService ;
import ma.zs.stocky.bean.core.appartenance.Nationalite ;
import ma.zs.stocky.service.facade.encadrant.appartenance.GenreEncadrantService ;
import ma.zs.stocky.bean.core.appartenance.Genre ;

import java.util.List;
@Service
public class EtudiantEncadrantServiceImpl implements EtudiantEncadrantService {
    ...
    @Autowired
    private NationaliteEncadrantService nationaliteService ;
    @Autowired
    private GenreEncadrantService genreService ;
