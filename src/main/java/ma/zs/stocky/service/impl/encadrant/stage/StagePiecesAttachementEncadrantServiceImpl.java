...
import java.util.List;
@Service
public class StagePiecesAttachementEncadrantServiceImpl implements StagePiecesAttachementEncadrantService {
    ...
    @Autowired
    private PiecesAttachementEncadrantService piecesAttachementService ;
    @Autowired
