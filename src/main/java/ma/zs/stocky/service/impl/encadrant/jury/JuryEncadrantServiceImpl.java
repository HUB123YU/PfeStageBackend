package ma.zs.stocky.service.impl.encadrant.jury;
...
import java.util.List;
@Service
public class JuryEncadrantServiceImpl implements JuryEncadrantService {
    ...
    @Autowired
    private JuryEncadrantInterneEncadrantService juryEncadrantInterneService ;
