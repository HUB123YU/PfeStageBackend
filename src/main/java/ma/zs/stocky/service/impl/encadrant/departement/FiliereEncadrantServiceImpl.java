package ma.zs.stocky.service.impl.encadrant.departement;
...
import ma.zs.stocky.service.facade.encadrant.departement.DepartementEncadrantService ;
import ma.zs.stocky.bean.core.departement.Departement ;

import java.util.List;
@Service
public class FiliereEncadrantServiceImpl implements FiliereEncadrantService {
    ...
    @Autowired
    private DepartementEncadrantService departementService ;
