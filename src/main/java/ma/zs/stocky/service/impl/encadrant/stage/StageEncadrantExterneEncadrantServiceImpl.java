...
import ma.zs.stocky.service.facade.encadrant.encadrant.EncadrantExterneEncadrantService ;
import ma.zs.stocky.bean.core.encadrant.EncadrantExterne ;

import java.util.List;
@Service
public class StageEncadrantExterneEncadrantServiceImpl implements StageEncadrantExterneEncadrantService {
    ...
    @Autowired
    private EncadrantExterneEncadrantService encadrantExterneService ;
