...
import java.util.List;
@Service
public class StagePiecesAttachementEtudiantServiceImpl implements StagePiecesAttachementEtudiantService {
    ...
    @Autowired
    private PiecesAttachementEtudiantService piecesAttachementService ;
    @Autowired
