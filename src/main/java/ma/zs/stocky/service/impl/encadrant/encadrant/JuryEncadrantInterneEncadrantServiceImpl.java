package ma.zs.stocky.service.impl.encadrant.encadrant;
...
import ma.zs.stocky.service.facade.encadrant.encadrant.JuryEncadrantInterneEncadrantService;
...
import java.util.List;
@Service
public class JuryEncadrantInterneEncadrantServiceImpl implements JuryEncadrantInterneEncadrantService {
    ...
    @Autowired
    private EncadrantInterneEncadrantService encadrantInterneService ;
    @Autowired
