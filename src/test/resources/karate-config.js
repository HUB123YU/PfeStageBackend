function fn() {
    ...
    config.piecesAttachementUrl = config.adminUri + 'piecesAttachement/';
    config.departementUrl = config.adminUri + 'departement/';
    config.typePiecesAttachementUrl = config.adminUri + 'typePiecesAttachement/';
    ...
    config.stagePiecesAttachementUrl = config.adminUri + 'stagePiecesAttachement/';
